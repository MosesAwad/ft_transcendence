...
async function notificationRoutes(fastify, options) {
	...
	// sent you a message'. In that scenario, we want to update the notification to say that is_read is true even though because 
	// even though the user technically has not read the notification yet, he already knows that he has received a message. The 
